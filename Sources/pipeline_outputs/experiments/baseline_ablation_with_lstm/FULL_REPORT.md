...
> [Sources/vppm/baseline_ablation_with_lstm/PLAN.md](../../vppm/baseline_ablation_with_lstm/PLAN.md).
...
| **E4** | 그룹 — G4 전체 | Scan 3ch | 18 | `docker/ablation/scan/` |
...
| **E34** | CAD 단일 채널 | distance_from_edge (idx 0) | 20 | `docker/ablation/cad_sub/` |
...
for E in E4 E32 E33 E34 E2 E1; do
  ./venv/bin/python -m Sources.vppm.baseline_ablation_with_lstm.analyze_per_build --experiment $E
done
