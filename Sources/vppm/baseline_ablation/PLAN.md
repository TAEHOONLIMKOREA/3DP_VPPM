...
>
> **종합 결과 보고서 (v2)**: [FULL_REPORT.md](../../pipeline_outputs/experiments/baseline_ablation/FULL_REPORT.md) — 배경 / 27 실험 결과 / 그룹별 해석 / 후속 로드맵.
...
> [FULL_REPORT.md](../../pipeline_outputs/experiments/baseline_ablation/FULL_REPORT.md), 자동 표는 [summary.md](../../pipeline_outputs/experiments/baseline_ablation/summary.md).
...
도커 실행: [docker/baseline_ablation/scan_sub/](../../../docker/baseline_ablation/scan_sub/)
...
도커 실행: [docker/baseline_ablation/](../../../docker/baseline_ablation/) `--profile cad_sub`
...
| 실험군 | 도커 경로 |
|:------|:---------|
| E1 (dscnn) | [docker/baseline_ablation/dscnn/](../../../docker/baseline_ablation/dscnn/) |
| E2 (sensor) | [docker/baseline_ablation/sensor/](../../../docker/baseline_ablation/sensor/) |
| E3 (cad)   | [docker/baseline_ablation/cad/](../../../docker/baseline_ablation/cad/) |
| E4 (scan)  | [docker/baseline_ablation/scan/](../../../docker/baseline_ablation/scan/) |
| E5–E12 + E23/E24 | [docker/baseline_ablation/dscnn_sub/](../../../docker/baseline_ablation/dscnn_sub/) |
| E14–E22    | [docker/baseline_ablation/sensor_sub/](../../../docker/baseline_ablation/sensor_sub/) |
| E31–E33    | [docker/baseline_ablation/scan_sub/](../../../docker/baseline_ablation/scan_sub/) |
| E1–E4 병렬 | `docker/baseline_ablation/run_all.sh` |
...
21 개 피처 전체 표는 [FULL_REPORT.md §2.2](../../pipeline_outputs/experiments/baseline_ablation/FULL_REPORT.md) 참조.
...
```bash
./venv/bin/python -m Sources.vppm.baseline_ablation.analyze_per_build --experiment E{id}
# → Sources/pipeline_outputs/experiments/baseline_ablation/E{id}_no_{group}/per_build_analysis.md
```
...
상세는 [FULL_REPORT.md §7](../../pipeline_outputs/experiments/baseline_ablation/FULL_REPORT.md) 참조.
...
```
Sources/vppm/baseline_ablation/
