...
- `Sources/vppm/baseline_ablation/run_hidden_sweep.py` 신설 — `EXPERIMENTS` dict 와 동일 패턴, 단 drop_group 대신 `hidden_dim` 인자 사용.
...
./venv/bin/python -m Sources.vppm.baseline_ablation.run_hidden_sweep --hidden 64
./venv/bin/python -m Sources.vppm.baseline_ablation.run_hidden_sweep --hidden 256
...
- 피처 ablation 결과: [FULL_REPORT.md](../../pipeline_outputs/experiments/baseline_ablation/FULL_REPORT.md)
