...
```python
# Sources/vppm/baseline_ablation/run.py
EXPERIMENTS = {
...
```bash
./venv/bin/python -m Sources.vppm.baseline_ablation.run --experiment E13
./venv/bin/python -m Sources.vppm.baseline_ablation.run --rebuild-summary  # summary.md 갱신
```
