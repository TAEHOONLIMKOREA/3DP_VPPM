...
>
> **배경**: 기존 ablation 결과 (`summary.md`) 에서 두 그룹은 ΔRMSE 상위 2개:
> - E1 (no-DSCNN):  ΔUTS +7.46 / ΔUE +2.40 / ΔTE +2.67
> - E2 (no-sensor): ΔUTS +5.75 / ΔUE +1.13 / ΔTE +1.16
>
...
### 3.1 리포트 템플릿 — `E13_analysis.md`

```markdown
# E13: DSCNN+Sensor 조합 Ablation 결과

| 속성 | E0 | E1 | E2 | **E13** | ΔE1+ΔE2 | ΔE13 | 시나리오 |
|:---:|:--:|:--:|:--:|:-------:|:-------:|:----:|:--------:|
| YS  | 28.7 | 31.0 | 31.2 | ? | +4.89 | ? | A/B/C |
| UTS | 60.7 | 68.2 | 66.5 | ? | +13.21 | ? | A/B/C |
| UE  | 12.8 | 15.2 | 13.9 | ? | +3.53 | ? | A/B/C |
| TE  | 15.5 | 18.1 | 16.6 | ? | +3.83 | ? | A/B/C |

## Naive 대비
E13 이 naive RMSE (YS 33.9 / UTS 68.4 / UE 15.0 / TE 18.5) 를 **초과하면 역효과** (CAD+Scan 만으로는 평균 예측보다 나쁨).
```
