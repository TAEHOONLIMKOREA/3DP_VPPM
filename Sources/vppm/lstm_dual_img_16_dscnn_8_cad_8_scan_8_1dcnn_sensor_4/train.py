"""Phase S4 — VPPM-LSTM-Dual-Img-16-DSCNN-8-CAD-8-Scan-8-1DCNN-Sensor-4 학습.
...
`lstm_dual_img_4_sensor_7_dscnn_8/train.py` 와 동일 골격. 차이는 (1) 모델 클래스
`VPPM_LSTM_Dual_Img_16_DSCNN_8_CAD_8_Scan_8_1DCNN_Sensor_4`, (2) forward 입력에
cad_patch + scan_patch 추가 (8-tuple), (3) 저장 prefix.
"""
...
from .model import VPPM_LSTM_Dual_Img_16_DSCNN_8_CAD_8_Scan_8_1DCNN_Sensor_4

MODEL_FILE_PREFIX = "vppm_lstm_dual_img_16_dscnn_8_cad_8_scan_8_1dcnn_sensor_4"
...
def train_single_fold(
    ...
    model = VPPM_LSTM_Dual_Img_16_DSCNN_8_CAD_8_Scan_8_1DCNN_Sensor_4().to(device)
...
def train_all(
    dataset: dict,
    output_dir: Path = config.LSTM_FULL86_MODELS_DIR,
    device: str = "cpu",
) -> dict:
