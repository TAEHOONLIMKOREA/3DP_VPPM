...
[Sources/vppm/baseline_ablation/PLAN_hidden_dim_sweep.md](../../Sources/vppm/baseline_ablation/PLAN_hidden_dim_sweep.md) 의 hidden_dim sweep 실험을 단일 docker-compose 로 실행.
...
- 각 hidden run: `Sources/pipeline_outputs/experiments/baseline_ablation/H{1,2,3}_hidden_{1,64,256}/`
  - `models/` — fold 별 best 모델
  - `results/` — `metrics_raw.json`, 산점도/상관 plot
  - `features/normalization.json`
  - `experiment_meta.json`
- 통합 summary: `Sources/pipeline_outputs/experiments/baseline_ablation/hidden_sweep_summary.md` (E0 baseline 자동 인용)
